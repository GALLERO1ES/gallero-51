        ...
        {!isMobile ? (
          <nav>
            <ul className="flex items-center gap-8">
              ...
              <li><Link to="/eventos" className="nav-link text-lg font-mexican">Eventos</Link></li>
        ...
        <div className="fixed inset-0 top-16 bg-black/95 backdrop-blur-md z-30 animate-fade-in">
          <nav className="container-fluid py-10">
            <ul className="flex flex-col gap-6 text-center bg-black">
              ...
              <li>
                <Link to="/eventos" onClick={() => setMobileMenuOpen(false)} className="text-2xl nav-link inline-block font-mexican bg-black/40 px-6 py-2 rounded-lg w-full">
                  Eventos
                </Link>
              </li>
              <li>
